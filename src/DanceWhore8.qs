...
'Три негра повели вас в комнату.'
...
act 'Сесть на корточки':
	...
	'<center><img src="images/qwest/alter/dance/bjtn.jpg"></center>'
	...
	tipdarand = 0
	if tipdarand = 0:
		'Негры переговариваясь на непонятном языке поставили вас раком.'
		...
		act 'Расслабить попку и сосать':
			...
			'<center><img src="images/qwest/alter/dance/fn.jpg"></center>'
			...
			act 'Далее':
				...
				elseif tipdarand = 1:
					...
					'<center><img src="images/qwest/alter/dance/swallowtn.jpg"></center>'
					'Вы встали на колени и с готовностью открыли рот. Негры начали кончать вам в открытый рот заполняя его спермой. Когда поток спермы прекратился и ваш рот оказался до краев наполнен спермой, вы ее проглотили.'
				end
